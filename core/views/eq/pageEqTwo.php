<div class="popup-link">
    <div class="popup-link__inner">
        <div class="container">
            <div class="popup-link__title"><?php echo carbon_get_post_meta(get_the_ID(), 'eq_title_top_contr'); ?></div>
            <div class="popup-link__subtitle"><?php echo carbon_get_post_meta(get_the_ID(), 'eq_text_top_contr'); ?></div>
            <div class="popup-link__item">Читать полностью</div>
        </div>
    </div>
</div>
<div class="tabs-inner">
    <div class="tabs-slider">
        <div class="tabs-slider__swiper-container swiper-container">
            ...
            <ul class="tabs-slider__swiper-wrapper swiper-wrapper" id="wrap">
                <?php $topTab =  carbon_get_post_meta(get_the_ID(), 'complex_tab_two');?>
                <?php foreach ( $topTab as $key => $topTabs ): ?>
                    <?php $key+=1; ?>
                    <?php $get = $_GET['params'] = 'tab'.$key; ?>
                    <?if($topTabs['crb_tab_include']==1){?>
                    <li data-params="<?php echo $get; ?>" class="tabs-slider__swiper-slide swiper-slide <?php if(in_array('white', $topTabs['crb_adv_side_two'])){ echo 'tabs-slider__swiper-slide_white'; } ?>" id="tab-<?= $key; ?>">
                        <a href="#tabs-<?= $key; ?>">
    ...
    <div class="tabs">
        <div class="tabs__inner">
            <?php $content = carbon_get_post_meta(get_the_ID(), 'complex_page_eq_two'); ?>
            <?php foreach ( $content as $contents ): ?>
                <?php $boxTab = $contents['complex_box_eq_two']; ?>
                            ...
                            <div class="tabs__content-inner">
                                    ...
                                    <div class="anchor">
                                        <div class="anchor__inner">
                                            <div class="anchor__controls-panel">
                                                <?php $leftTab = $boxTabs['complex_tab_left_eq_two']; ?>
                                                <?php foreach($leftTab as $num => $leftTabs): ?>
                                                    <a class="anchor__controls-panel-item">
                                                        ...
                                                        <div class="anchor__dropdown-name"><?php echo  $leftTabs['left_tab_name_eq']; ?></div>
                                    ...
                                    <div class="contacts">
                                        <div class="contacts__inner">
                                            ...
                                            <div class="contacts__links">
                                                ...
                                                <div class="socials">
                                                    <div class="socials__inner"><a class="socials__item" href="#">
                                ...
                                <div class="tabs__right-bar">
                                    <div class="tabs__content-bgd">
                                        <img class="tabs__content-bgd-pic" src="<?php echo wp_get_attachment_image_url($boxTabs['img_what_two'], 'full');  ?>" alt="" role="presentation"/>
                                    </div>
                                    <div class="tabs-content">
                                        <div class="tabs-content__inner">
                                            <div class="tabs-content__dropdown-inner">
                                                <?php foreach ($leftTab as $num => $leftTabs): ?>
                                                    <?php $contentTab = $leftTabs['complex_content_eq_two']; ?>
                                                    <?php foreach ($contentTab as $centContentTwo): ?>
                                                        <div class="tabs-content__dropdown-item">
                                                            <div class="tabs-content__dropdown-title-inner">
                                                                ...
                                                                <div class="tabs-content__dropdown-name"><?php echo  $leftTabs['left_tab_name_eq']; ?></div>
                                                            ...
                                                            <div class="tabs-content__subtab-content">
                                                                <h3 class="tabs-content__subtab-content-title"><?php echo $centContentTwo['what_this_two']; ?></h3>
                                                                <div class="tabs-content__subtab-content-item">
                                                                    <h4></h4>
                                                                    <?php echo $centContentTwo['leader_text_two']; ?>
                                                                </div>
                                                                <?php if (!empty($centContentTwo['text_point_two'])) { ?>
                                                                    <div class="tabs-content__subtab-content-item tabs-content__subtab-content-item tabs-content__subtab-content-item_active">
                                                                        <h4>Суть:
                                                                        </h4>
                                                                        <p><?php echo $centContentTwo['text_point_two']; ?></p>
                                                                    </div>
                                                                <?php } if (!empty($centContentTwo['text_goal_two'])){ ?>
                                                                    <div class="tabs-content__subtab-content-item tabs-content__subtab-content-item tabs-content__subtab-content-item_active">
                                                                        <h4>Цель:
                                                                        </h4>
                                                                        <p><?php echo $centContentTwo['text_goal_two']; ?></p>
                                                                    </div>
                                                                <?php } if (!empty($centContentTwo['text_raisin_two'])){ ?>
                                                                    <div class="tabs-content__subtab-content-item tabs-content__subtab-content-item tabs-content__subtab-content-item_active-bgd">
                                                                        ...
                                                                        <p><?php echo $centContentTwo['text_raisin_two']; ?></p>
                                                                    </div>
                                                                <?php } ?>
                                                                <?php $accord = $centContentTwo['complex_accord_eq']; ?>
                                                                <?php if (!empty($accord)){ ?>
                                                                    <div class="tabs-content__subtab-content-item">
                                                                        <?php foreach ($accord as $accords): ?>
                                                                            <div class="tabs-content__accordion">
                                                                                <div class="tabs-content__accordion-title">
                                                                                    ...
                                                                                    <div class="tabs-content__accordion-title-level"><span style="color: #252f3d;"><?= $accords['level_accord']; ?></span>
                                                                ...
                                                                <?php } ?>
                                                                <?php $table = $centContentTwo['complex_table_eq_two']; ?>
                                                                <?php if (!empty($table)): ?>
                                                                                                ...
                                                                                                <?php foreach($tabBlock as $tabBlocks): ?>
                                                                                                    <div class="tabs-content__problem-inner">
                                                                                                        ...
                                                                                                        <?php foreach ($tableContent as $tableText): ?>
                                                                                                            <div class="tabs-content__problem-description"><?= $tableText['text_table'] ?></div>
                                                                                                        <?php endforeach; ?>
                                                                                                    </div>
                                                                                                <?php endforeach; ?>
                                                                                            </div>
                        ...
                        <div class="form__addContent"><span class="form__titleText">Спасибо!</span><span class="form__descText">Ваше сообщение успешно отправлено.  В ближайшее время мы обязательно свяжемся с вами</span>
                                                    ...
                                                    <div class="form__agreement">
                                                        <label class="form__container">Я согласен с условиями обработки данных
                                                            <input type="checkbox" checked="checked"><span class="form__checkmark"></span>
                                                        </label>
