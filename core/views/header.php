        ...
        <div class="header__dropdown-menu-inner">
            ...
            <a class="header__dropdown-menu-link" href="<?php echo get_home_url(); ?>">
                ...
                <div class="header__filter-header">
                    ...
                    <div class="header__menu-link-title">Главная страница</div>
...
<!--                <div class="header__lang"><img class="header__lang-icon" src="/wp-content/themes/Sanko/src/icons/lang-icon.svg" alt="" role="presentation"/><a class="header__lang-link header__lang-link header__lang-link_active" href="#">RU</a><a class="header__lang-link" href="#">EN</a>-->
        ...
        <div class="header__inner">
            ...
            <a href="<?php get_home_url(); ?>">
                ...
                <div class="header__logo">
                    ...
                    <img class="header__logo-pic" src="<?php echo carbon_get_theme_option('logo'); ?>" alt="" role="presentation"/>
            ...
            <div class="lang" style="display:none">
              ...
              <div class="lang__label">
                ...
                <div class="lang__icon login__icon-label">
